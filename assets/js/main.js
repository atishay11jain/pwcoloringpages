...
; (function ($) {
    ...
    $('#popup_bid').on('hidden.bs.modal', function () {
        $(this).find('input').val('');  // Clear email input
        $('#error-message').text('');   // Remove any error message
        $(this).removeData('bs.modal'); // Remove Bootstrap's stored data
    });
    ...
    var subscribePopup = function () {
        document
            ...
            .addEventListener("click", async function (event) {
                ...
                errorMessage.style.color = "#DE3163";
                ...
                errorMessage.style.color = "#578FCA";
                errorMessage.textContent = "Subscribing...";

                try {
                    let response = await fetch(
                        "https://script.google.com/macros/s/AKfycbyN6mbG7WfFOACzDZYD8sn16RrKYUuE7hLjs5XPWg0YQaVewQxC6joVWoT3Uln6hTj5/exec",
                        {
                            method: "POST",
                            headers: {
                    ...
                    errorMessage.style.color = "#29b24b";
                    errorMessage.textContent = "Subscribed successfully!";

                    setTimeout(() => {
                        document.querySelector('.close[data-dismiss="modal"]').click();
                    }, 1000);
                } catch (error) {
